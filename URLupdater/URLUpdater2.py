...
path="U:/2016TigerFiles/2017Files/addrfn"
...
for fileA in configfiles:
    ...
    for x in f:
        ...
        if re.search('2017-12-12', x, flags=0):
            ...
            DatesUpdated =metadataDateUpdater(DatesUpdated)
       #elif re.search('docucomp',x,flags=0):
        #    if re.search('c5ceb003-1ed6-4126-8a16-bc08ce8fc267',x,flags=0):
         #       print ("suspect line!!!!!!!!")
          #      nf.write(x)
           # else:
            #    nf.write(x)
       # elif re.search('Spatial Data Collection and Products Branch',x , flags=0):
        #    nf.write("  <gmd:pointOfContact xlink:href=\"https://www.ngdc.noaa.gov/docucomp/c5ceb003-1ed6-4126-8a16-bc08ce8fc267")
         #   nf.write(x)
       # elif re.search(' </gmd:status>',x,flags=0):
        #    nf.write(x)
         #   nf.write('<gmd:pointOfContact xlink:href="https://www.ngdc.noaa.gov/docucomp/09b8253a-e2dc-4a6b-a905-11f1e0e87b3b/"')
        #elif re.search('<gmd:contact xlink:href=\"https://www.ngdc.noaa.gov/docucomp/B04DFA5D-40CD-B677-E040-0AC8C5BB4473',x,flags=0):
         #   if docuCompCounter>1:
          #      nf.write(x)
           #     docuCompCounter=0
           # else:
            #    docuCompCounter+=1
...
print ("copying the new files into the new files-----------------------------")
