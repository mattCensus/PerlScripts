...
path = 'C:/Users/mattp/Desktop/WorkFiles/XMLFiles/2020files/FE2020/StatesNew/tabblock10'
...
SeriesTheme='2010 Census  Block State-based State-based Shapefile'
        ...
        for line in ReadFile:
            if re.search('gmd:linkage', line, flags=0):
                ...
                if transferOptionsCounter == 0:
                    ...
                    NewFile.write(
                        ' <gco:CharacterString> This zip file contains the ' + actualFile + ' shapefile </gco:CharacterString>\n')
                    NewFile.write('</gmd:description>\n')
                ...
                if re.search('>ANSI INCITS 38:2009', line, flags=0):
                    ...
                    NewFile.write(
                        '<gco:CharacterString>National Standard Codes (ANSI INCITS 38-2009)</gco:CharacterString>')
                elif re.search('<gco:CharacterString>MAF/TIGER</gco:CharacterString>', line, flags=0):
                    # ind#3
                    NewFile.write(line)
                    MafTigerInd = 'yes'
                ...
                if MafTigerInd == 'yes':
                    ...
                    NewFile.write(line)
            elif re.search('https://www2.census.gov/geo/tiger/TIGER2020PL/',line, flags=0):
                lastdash=line.rfind('/')+1
                filenameUrl=line[lastdash:]
                basename='https://www2.census.gov/geo/tiger/TIGER2020/'
                newUrl=basename+filenameUrl
                NewFile.write(newUrl)
