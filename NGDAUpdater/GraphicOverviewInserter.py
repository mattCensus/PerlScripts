...
path = 'C:/Users/mattp/Desktop/WorkFiles/XMLFiles/2020files/PL2020/XMLFiles/stateMetadataFiles/uga20'
...
for file in configfiles:
    ...
    with  open(OutFile, "w", encoding="utf8") as NewFile:
        for line in ReadFile:
            if re.search('<gco:CharacterString>TIGER/Line Shapefile, 2020,',line, flags=0):
                NewFile.write(line)
