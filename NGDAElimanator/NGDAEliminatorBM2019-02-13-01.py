...
path='C:/Users/mattp/Desktop/WorkFiles/XML Files/ISO Files/2017Files/tbg'
...
NumOfFiles=str(len(newFilesList))
print("The number of Files in the directory is %s" % NumOfFiles)
