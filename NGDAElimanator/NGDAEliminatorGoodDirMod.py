...
#path ="U:/2016TigerFiles/2018Files/scsd"
...
path='C:/Users/mattp/Desktop/WorkFiles/XML Files/ISO Files/2018Tiger/cnecta'
#C:\Users\mattp\Desktop\WorkFiles\XML Files\ISO Files\2018Tiger
...
for fileB in newFilesList:
    ...
    if tenCounter == 30:
        if numOfFiles >0:
            perDone=round((filesDone/countFiles)*100,3)
        tenCounter=0
...
#for susFile in newFilesListFinal:
 #   if re.search('newfile',susFile, flags=0):
  #      print ("Found a file to be removed:" + susFile + "!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n\n")
   ...
   #     abletoWrite= os.access(susFile, os.W_OK)
    #    if abletoWrite:
     #       print ( susFile + " is still open")
      #      #os.close(susFile)
       # else:
        #    print(susFile + " is CLOSED!!!!!!!!!")
         #   os.remove(susFile)
